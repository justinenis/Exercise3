...
## I. Overview 
The objective is to analyze the provided data of residential housing in the state of California and develop a predictive model that could accurately determine the median house value based on several features. This model could be helpful in determining a pattern of median house values in the state. 
